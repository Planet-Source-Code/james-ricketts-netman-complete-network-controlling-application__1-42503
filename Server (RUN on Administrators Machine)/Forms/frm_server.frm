...
Begin VB.Form frm_server 
   ...
   Caption         =   "Jamesosoft Netman 2002 - Server"
   ClientHeight    =   4500
   ClientLeft      =   150
   ClientTop       =   540
   ClientWidth     =   12735
   ...
   Begin VB.Frame Frame2 
      ...
      Begin VB.ListBox list_multi 
         Height          =   840
         ItemData        =   "frm_server.frx":04B2
         Left            =   120
         List            =   "frm_server.frx":04B4
   ...
   Begin MSComctlLib.ImageList ImageList1 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frm_server.frx":04B6
            Key             =   "xp"
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frm_server.frx":0FD0
            Key             =   "2k"
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frm_server.frx":1AEA
            Key             =   "w95"
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frm_server.frx":2604
            Key             =   "w98"
         EndProperty
         BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frm_server.frx":311E
            Key             =   "me"
         EndProperty
         BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frm_server.frx":3C38
            Key             =   "nt3"
         EndProperty
         BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frm_server.frx":4752
            Key             =   "nt4"
         EndProperty
      EndProperty
   End
...
frm_server.caption = App.CompanyName & " " & App.ProductName & " v" & App.Major & "." & App.Minor & "." & App.Revision & _
